...
const Modal: React.FC<ModalProps> = ({
  isOpen, onClose, onSubmit, title, body, footer, actionLabel,
  ...
  //in order to add some animation for 300ms
      ...
      <div className='justify-center items-center flex overflow-x-hidden overflow-y-auto
        ...
        <div className='relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto 
          ...
          ${showModal ? 'opacity-100' : 'opacity-0'}`
            ...
            shadow-lg relative flex flex-col w-full bg-white outline-none focul:outline-none'>
              {/* Header */}
